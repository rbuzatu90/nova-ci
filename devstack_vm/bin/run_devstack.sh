...
echo "trusted-host = $PIP_SERVER" >> $HOME/.pip/pip.conf
echo "index-url = http://$PIP_SERVER:8080/cloudbase/CI/+simple/" >> $HOME/.pip/pip.conf
...
sed -i "s#PIP_GET_PIP_URL=https://bootstrap.pypa.io/get-pip.py#PIP_GET_PIP_URL=http://$DL_SERVER:8080/get-pip.py#g" /home/ubuntu/devstack/tools/install_pip.sh
