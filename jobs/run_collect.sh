...
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -ExecutionPolicy RemoteSigned Copy-Item -Recurse C:\OpenStack\Log\* \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned C:\OpenStack\nova-ci\HyperV\scripts\export-eventlog.ps1'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned cp -Recurse -Container  C:\OpenStack\Logs\Eventlog\* \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\'

run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'systeminfo >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\systeminfo.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'wmic qfe list >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\windows_hotfixes.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'pip freeze >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\pip_freeze.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'ipconfig /all >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\ipconfig.log'

run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned get-netadapter ^| Select-object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\get_netadapter.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned get-vmswitch ^| Select-object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\get_vmswitch.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned get-WmiObject win32_logicaldisk ^| Select-object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\disk_free.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned get-netfirewallprofile ^| Select-Object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\firewall.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned get-process ^| Select-Object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\get_process.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'powershell -executionpolicy remotesigned get-service ^| Select-Object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\get_service.log'

run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'sc qc nova-compute >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\nova_compute_service.log'
run_wsmancmd_with_retry $hyperv01 $CERT $KEY 'sc qc neutron-hyperv-agent >> \\'$FLOATING_IP'\openstack\logs\'${hyperv01%%[.]*}'\neutron_hyperv_agent_service.log'

run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned C:\OpenStack\nova-ci\HyperV\scripts\export-eventlog.ps1'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned cp -Recurse -Container  C:\OpenStack\Logs\Eventlog\* \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\'

run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -ExecutionPolicy RemoteSigned Copy-Item -Recurse C:\OpenStack\Log\* \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'systeminfo >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\systeminfo.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'wmic qfe list >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\windows_hotfixes.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'pip freeze >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\pip_freeze.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'ipconfig /all >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\ipconfig.log'

run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned get-netadapter ^| Select-object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\get_netadapter.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned get-vmswitch ^| Select-object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\get_vmswitch.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned get-WmiObject win32_logicaldisk ^| Select-object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\disk_free.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned get-netfirewallprofile ^| Select-Object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\firewall.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned get-process ^| Select-Object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\get_process.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'powershell -executionpolicy remotesigned get-service ^| Select-Object * >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\get_service.log'

run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'sc qc nova-compute >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\nova_compute_service.log'
run_wsmancmd_with_retry $hyperv02 $CERT $KEY 'sc qc neutron-hyperv-agent >> \\'$FLOATING_IP'\openstack\logs\'${hyperv02%%[.]*}'\neutron_hyperv_agent_service.log'
